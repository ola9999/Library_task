...
class BorrowedBookViewSetTest(
    ...
    def setUpTestData(cls):
        ...
        cls.borrowedbook_to_delete =cls.create_book(
            **{
                'client_id':cls.client1.id,
                'book_id':cls.book2.id,
            },
        )
        
        # Common Endpoints
        cls.list_endpoint = reverse('borrowedbook-list')
        cls.detail_endpoint =  reverse(
            'borrowedbook-detail',
